...
import {  AvaliableAppointment, Cart, CartToProduct } from "../../interfaces";
...
const CartModal = () => {
  ...
  const handleAvailiableAppointmentId = (avaliableAppointmentId: string, appointment?: AvaliableAppointment) => {
